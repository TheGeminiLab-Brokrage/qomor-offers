...
const STRINGS = {
  en: {
    ...
    'save.detailPlan': '{pct} off the list price, plus {plan} for the payment terms — list price {list} {currency}, your price {price} {currency}. The instalment plan below is calculated on your price.',
    'save.detailPlanOnly': '{plan} off for the payment terms — was {list} {currency}, your price {price} {currency}. The instalment plan below is calculated on your price.',

    'npv.open': 'NPV',
    'npv.codeLabel': 'Enter the passcode to customise this plan',
    'npv.codeGo': 'Unlock',
    'npv.codeWrong': 'Wrong passcode.',
    'npv.codeInsecure': 'This check needs the secure (https) address of the app.',
    'npv.title': 'Customise the payment plan',
    'npv.sub': 'Starting from the {plan} plan. Raise the down payment, shorten the plan, or both.',
    'npv.down': 'Down payment',
    'npv.downHint': 'Standard for this plan is {stdAmount} {currency}',
    'npv.term': 'Term',
    'npv.years': 'Years',
    'npv.instCount': 'Instalments',
    'npv.instUnit': 'payments',
    'npv.instHint': '{n} quarterly payments · standard {std} years',
    'npv.instHintCount': '{y} years · standard {std} payments',
    'npv.termYears': '{y} years',
    'npv.termInst': '{n} quarterly payments',
    'npv.rangeMoney': 'Enter an amount from {min} to {max} {currency}.',
    'npv.rangeTerm': 'Enter from {min} to {max}.',
    'npv.maxLabel': 'Maximum discount you can give',
    'npv.vs': 'Compared with the {plan} plan.',
    'npv.changes': 'What he is offering',
    'npv.chgDown': 'Down payment',
    'npv.chgTerm': 'Term',
    'npv.chgQuarter': 'Each quarter',
    'npv.chgYear': 'Each year',
    'npv.moreMoney': '{amount} {currency} more',
    'npv.sameAsStd': 'same as standard',
    'npv.shorterBy': '{y} years shorter',
    'npv.shorterBy1': '1 year shorter',
    'npv.ratePair': '{now} instead of {was} · {delta} more',
    'npv.ratePairLess': '{now} instead of {was} · {delta} less',
    'npv.ratePairSame': '{now}, unchanged',
    'npv.gap': 'Note: there is no standard plan between {from} and {to}, so this is measured against the {to} plan and reads generous.',
    'npv.yearsUnit': 'years',
    'npv.none': 'Nothing has changed yet. Raise the down payment or shorten the plan.',
    'npv.premium': 'These terms are worth less to the company than the {plan} plan, so they earn no discount.',
    'npv.invalid': 'The down payment and milestones leave nothing for the instalments. Lower the down payment.',
    'npv.give': 'Discount to give',
    'npv.keeps': 'Company keeps {pct} ({amount} {currency}) · new price {price} {currency}',
    'npv.apply': 'Apply to offer',
    'npv.remove': 'Remove',
    'npv.close': 'Close',
    'npv.applied': 'Applied. The schedule below and the offer now use these terms at {pct} off.',
    'npv.chip': 'Custom plan · {pct} off',
    'npv.movedLonger': 'Moved to the {to} plan — the {from} plan does not run that long.',
    'npv.movedShorter': 'Moved to the {to} plan — the {from} plan starts at {down} {currency}.',
    'npv.needMoreDown': 'For {term} you need the {plan} plan, which starts at {down} {currency}. Raise the down payment first.',
    'npv.instMax': 'At most {term} (the {plan} plan).',
    'npv.downBelow': 'The {plan} plan starts at {down} {currency}. Leave the field to move to the {to} plan.',
    'npv.downTooLow': 'With {down} {currency} the longest you can spread is {term} (the {plan} plan). Shorten the plan first.',
    'npv.downMinAll': 'No plan starts below {down} {currency}.',
    'npv.lumps': 'Lump sums kept: {list} · each quarter {each}',
    'npv.lumpsNone': 'No lump sums · each quarter {each}',
    'npv.lumpItem': '{pct} at month {m}',
    ...
    /* The WhatsApp post (js/post.js). These label the CONTROLS, so they follow
       the app's language — the post itself is always Arabic, because it is
       going to an Egyptian broker group whatever language the agent works in. */
    'post.open': 'WhatsApp post',
    'post.title': 'WhatsApp post',
    'post.sub': 'The listing post for this unit, with the drawing pinned. Edit anything before sending — the numbers come from the live sheet.',
    'post.short': 'Short',
    'post.long': 'Full',
    'post.terms': 'Include payment terms',
    'post.send': 'Send on WhatsApp',
    'post.copy': 'Copy text',
    'post.close': 'Close',
    'post.sent': 'Sent. The text went with the image as its caption.',
    'post.sentImageOnly': 'Image sent — the text is on your clipboard, paste it as the caption.',
    'post.cancelled': 'Cancelled.',
    'post.saved': 'Image saved and the text copied — attach it in WhatsApp and paste.',
    'post.savedNoCopy': 'Image saved. Copy the text above, then attach the image in WhatsApp.',
    'post.copied': 'Copied. Paste it into WhatsApp.',
  ...
  ar: {
    ...
    'save.detailPlan': 'خصم {pct} من السعر قبل الخصم، وخصم إضافي {plan} مقابل شروط السداد — السعر قبل الخصم {list} {currency}، وسعرك {price} {currency}. خطة الأقساط أدناه محسوبة على سعرك.',
    'save.detailPlanOnly': 'خصم {plan} مقابل شروط السداد — السعر كان {list} {currency}، وسعرك {price} {currency}. خطة الأقساط أدناه محسوبة على سعرك.',

    'npv.open': 'NPV',
    'npv.codeLabel': 'أدخل الرمز لتعديل هذه الخطة',
    'npv.codeGo': 'فتح',
    'npv.codeWrong': 'الرمز غير صحيح.',
    'npv.codeInsecure': 'هذا التحقق يحتاج إلى العنوان الآمن (https) للتطبيق.',
    'npv.title': 'تعديل خطة السداد',
    'npv.sub': 'بدءًا من خطة {plan}. زِد المقدم أو قصّر مدة الخطة أو الاثنين معًا.',
    'npv.down': 'المقدم',
    'npv.downHint': 'الأساسي في هذه الخطة {stdAmount} {currency}',
    'npv.term': 'المدة',
    'npv.years': 'سنوات',
    'npv.instCount': 'عدد الأقساط',
    'npv.instUnit': 'قسط',
    'npv.instHint': '{n} قسط ربع سنوي · الأساسي {std} سنة',
    'npv.instHintCount': '{y} سنة · الأساسي {std} قسط',
    'npv.termYears': '{y} سنة',
    'npv.termInst': '{n} قسط ربع سنوي',
    'npv.rangeMoney': 'أدخل مبلغًا من {min} إلى {max} {currency}.',
    'npv.rangeTerm': 'أدخل من {min} إلى {max}.',
    'npv.maxLabel': 'أقصى خصم يمكنك منحه',
    'npv.vs': 'مقارنةً بخطة {plan}.',
    'npv.changes': 'ما يقدّمه العميل',
    'npv.chgDown': 'المقدم',
    'npv.chgTerm': 'المدة',
    'npv.chgQuarter': 'كل قسط ربع سنوي',
    'npv.chgYear': 'كل سنة',
    'npv.moreMoney': 'زيادة {amount} {currency}',
    'npv.sameAsStd': 'كما في الخطة الأساسية',
    'npv.shorterBy': 'أقصر بـ {y} سنة',
    'npv.shorterBy1': 'أقصر بسنة واحدة',
    'npv.ratePair': '{now} بدلاً من {was} · زيادة {delta}',
    'npv.ratePairLess': '{now} بدلاً من {was} · أقل بـ {delta}',
    'npv.ratePairSame': '{now} بدون تغيير',
    'npv.gap': 'ملاحظة: لا توجد خطة أساسية بين {from} و{to}، لذلك تتم المقارنة بخطة {to} ويظهر الخصم أكبر من المعتاد.',
    'npv.yearsUnit': 'سنة',
    'npv.none': 'لم يتغير شيء بعد. زِد المقدم أو قصّر مدة الخطة.',
    'npv.premium': 'هذه الشروط أقل قيمة للشركة من خطة {plan}، لذلك لا تستحق خصمًا.',
    'npv.invalid': 'المقدم والدفعات لا يتركان شيئًا للأقساط. قلّل المقدم.',
    'npv.give': 'الخصم الممنوح',
    'npv.keeps': 'تحتفظ الشركة بـ {pct} ({amount} {currency}) · السعر الجديد {price} {currency}',
    'npv.apply': 'تطبيق على العرض',
    'npv.remove': 'إلغاء',
    'npv.close': 'إغلاق',
    'npv.applied': 'تم التطبيق. الجدول أدناه والعرض يستخدمان هذه الشروط بخصم {pct}.',
    'npv.chip': 'خطة مخصصة · خصم {pct}',
    'npv.movedLonger': 'تم الانتقال إلى خطة {to} — خطة {from} لا تمتد لهذه المدة.',
    'npv.movedShorter': 'تم الانتقال إلى خطة {to} — خطة {from} تبدأ بمقدم {down} {currency}.',
    'npv.needMoreDown': 'لمدة {term} تحتاج إلى خطة {plan}، ومقدمها يبدأ من {down} {currency}. زِد المقدم أولاً.',
    'npv.instMax': 'الحد الأقصى {term} (خطة {plan}).',
    'npv.downBelow': 'خطة {plan} تبدأ بمقدم {down} {currency}. اخرج من الحقل للانتقال إلى خطة {to}.',
    'npv.downTooLow': 'بمقدم {down} {currency} أطول مدة ممكنة هي {term} (خطة {plan}). قصّر المدة أولاً.',
    'npv.downMinAll': 'لا توجد خطة بمقدم أقل من {down} {currency}.',
    'npv.lumps': 'الدفعات المحتفظ بها: {list} · كل قسط {each}',
    'npv.lumpsNone': 'بدون دفعات · كل قسط {each}',
    'npv.lumpItem': '{pct} في الشهر {m}',
    ...
    'post.open': 'بوست واتساب',
    'post.title': 'بوست واتساب',
    'post.sub': 'بوست الوحدة مع الرسم وعليه علامة الوحدة. عدّل ما تشاء قبل الإرسال — الأرقام مأخوذة من الشيت مباشرة.',
    'post.short': 'مختصر',
    'post.long': 'كامل',
    'post.terms': 'إضافة نظام السداد',
    'post.send': 'إرسال على واتساب',
    'post.copy': 'نسخ النص',
    'post.close': 'إغلاق',
    'post.sent': 'تم الإرسال. النص ذهب مع الصورة كتعليق عليها.',
    'post.sentImageOnly': 'تم إرسال الصورة — النص منسوخ، الصقه كتعليق عليها.',
    'post.cancelled': 'تم الإلغاء.',
    'post.saved': 'تم حفظ الصورة ونسخ النص — أرفق الصورة في واتساب والصق النص.',
    'post.savedNoCopy': 'تم حفظ الصورة. انسخ النص بالأعلى ثم أرفق الصورة في واتساب.',
    'post.copied': 'تم النسخ. الصقه في واتساب.',
...
const DATA_AR = {
  ...
  plan: {
    ...
    '9 years': '9 سنوات',
    '10 years': '10 سنوات',
    'Custom': 'مخصصة',          // a plan customised through js/npv.js
  },
...
const ASSUMPTIONS_AR = [
  ...
  'الصيانة 10% محسوبة على نفس السعر النهائي، وتُدفع دفعة واحدة في الشهر 42. ولا يخفضها أي خصم ممنوح مقابل شروط السداد.',
