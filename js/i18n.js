...
const STRINGS = {
  en: {
    ...
    'npv.downHint': '= {pct} of the price · standard {std} ({stdAmount} {currency})',
    'npv.term': 'Term',
    'npv.years': 'Years',
    'npv.instCount': 'Instalments',
    'npv.instUnit': 'payments',
    'npv.instHint': '= {n} quarterly payments, the last in month {m} · standard {std} years',
    'npv.instHintCount': '= {y} years, the last payment in month {m} · standard {std} payments',
    ...
    'npv.vs': 'Compared with the {plan} plan, the shortest standard plan his last payment fits inside, at {rate} a year.',
  ...
  ar: {
    ...
    'npv.down': 'المقدم',
    'npv.downHint': '= {pct} من السعر · الأساسي {std} ({stdAmount} {currency})',
    'npv.term': 'المدة',
    'npv.years': 'سنوات',
    'npv.instCount': 'عدد الأقساط',
    'npv.instUnit': 'قسط',
    'npv.instHint': '= {n} قسط ربع سنوي، آخرها في الشهر {m} · الأساسي {std} سنة',
    'npv.instHintCount': '= {y} سنة، وآخر قسط في الشهر {m} · الأساسي {std} قسط',
    'npv.termYears': '{y} سنة',
    ...
    'npv.vs': 'مقارنةً بخطة {plan}، وهي أقصر خطة أساسية ينتهي آخر قسط للعميل داخلها، بمعدل {rate} سنويًا.',
